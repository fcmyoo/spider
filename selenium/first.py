...
class DZLqh(object):
    ...
    def dz(self, url, proxyStr=None):
        ...
        try:
            ...
            for i in range(0, 20):
                self.driver.find_element_by_xpath("//li/h3/img[@data='99']").click()
                ...
                if msg.status_code == 200:
                    if 'success' in msg.text:
                        span_clk = self.driver.find_element_by_id('count_99').text
...
def get_proxy():
    r = requests.get('http://127.0.0.1:5000/?types=0&count=100&country=国外')
